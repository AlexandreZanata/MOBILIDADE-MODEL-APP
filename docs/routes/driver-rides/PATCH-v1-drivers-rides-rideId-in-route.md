...
**Tag:** Driver - Rides  
**Summary:** Mark in route  
**Description:** Driver indicates they are en route to the destination.  
...
- Called by `driverRidesFacade.markInRoute(rideId)` via `useMarkInRoute` mutation
