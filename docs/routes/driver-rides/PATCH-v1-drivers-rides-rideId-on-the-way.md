...
**Tag:** Driver - Rides  
**Summary:** Mark driver on the way  
**Description:** Driver indicates they are on the way to the pickup point.  
...
- Called by `driverRidesFacade.markOnTheWay(rideId)` via `useMarkOnTheWay` mutation
